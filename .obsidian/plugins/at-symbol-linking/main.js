...
// src/native-version/suggest-popup.ts
...
// src/extension-version/extension-handler.ts
var import_language2 = require("@codemirror/language");
var import_view = require("@codemirror/view");
var import_obsidian7 = require("obsidian");

// src/extension-version/extension-popup.ts
...
// src/extension-version/extension-handler.ts
var AtSymbolTriggerExtension = class {
  constructor(view) {
    this.firstOpenedCursor = null;
    this.openQuery = "";
    this.isOpen = false;
  ...
  handleKeyEvent(event) {
    var _a, _b, _c, _d, _e, _f, _g;
    let isInTitle = false;
    (((_a = event.target) == null ? void 0 : _a.classList) || []).forEach(
      (className) => {
    ...
    if (this.openQuery.split(" ").length - 1 > this.settings.leavePopupOpenForXSpaces || // Also close if the query starts with a space, regardless of space settings
    this.openQuery.startsWith(" ")) {
      return this.closeSuggestion();
    }
    if (!this.suggestionEl && this.firstOpenedCursor && this.view) {
      const container = this.app.dom.appContainerEl;
...
var editorPlugin = import_view.ViewPlugin.fromClass(AtSymbolTriggerExtension);
...
var AtSymbolLinking = class extends import_obsidian8.Plugin {
  ...
  giveExtensionProps(leaf) {
    var _a;
    const activeEditor = (_a = leaf == null ? void 0 : leaf.view) == null ? void 0 : _a.editor;
    if (activeEditor) {
      const editorView = activeEditor.cm;
      const editorPlug = editorView.plugin(editorPlugin);
      if (editorPlug) {
        this.activeExtension = editorPlug;
      }
      editorPlug == null ? void 0 : editorPlug.updateProps(this.app, this.settings);
    }
  }
  closeSuggestionListener(event) {
    let currentDepth = 0;
    let parent = event.target;
    let shouldClose = true;
    while (event.target && currentDepth < maxParentDepth) {
      currentDepth++;
      if (parent == null ? void 0 : parent.classList.contains("suggestion-context")) {
        shouldClose = false;
        break;
      }
